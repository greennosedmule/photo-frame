...
-- derivative_failures.
INSERT INTO meta (key, value) VALUES ('last_scan_at', '') ON CONFLICT DO NOTHING;
INSERT INTO meta (key, value) VALUES ('indexing_state', 'idle') ON CONFLICT DO NOTHING;
INSERT INTO meta (key, value) VALUES ('scan_total', '0') ON CONFLICT DO NOTHING;
INSERT INTO meta (key, value) VALUES ('scan_done', '0') ON CONFLICT DO NOTHING;
